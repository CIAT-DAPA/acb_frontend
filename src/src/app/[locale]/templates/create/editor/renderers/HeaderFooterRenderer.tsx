...
export const HeaderFooterRenderer: React.FC<HeaderFooterRendererProps> = ({
  config,
  type,
  globalStyle,
}) => {
  ...
  const containerStyle: React.CSSProperties = {
    ...
    wordSpacing: styleConfig.word_space || globalStyle?.word_space,
    ...
    // Borders
    borderTopWidth:
      type === "footer" ? styleConfig.border_width || "1px" : undefined,
    borderBottomWidth:
      type === "header" ? styleConfig.border_width || "1px" : undefined,
