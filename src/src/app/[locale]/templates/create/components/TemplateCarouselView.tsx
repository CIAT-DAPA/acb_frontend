...
interface TemplateCarouselViewProps {
 ...
 */
export function TemplateCarouselView({
  data,
  config = {},
  initialSection = 0,
}: TemplateCarouselViewProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="template-carousel-view relative w-full overflow-hidden"
